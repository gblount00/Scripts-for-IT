...
def open_NinjaOne():
   webbrowser.open("https://app.ninjarmm.com/#/systemDashboard/overview")
   
def open_Aavaya_Users():
   webbrowser.open("https://10.17.11.40/network-login/")
   
def open_Avaya_Voicemail():
   webbrowser.open("https://10.17.11.18/")
...
btn8 = tk.Button(buttonframe, text="Enbtra ID", font=("Consolas"),fg="white", command=open_Entra_ID)
